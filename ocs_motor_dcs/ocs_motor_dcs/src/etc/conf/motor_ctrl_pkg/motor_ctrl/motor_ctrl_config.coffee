...
module.exports =
    ...
    input_ports:
        speed:               { name: 'speed',                 protocol: 'pull',  url: 'tcp://127.0.0.1:30004', blocking_mode: 'async', max_rate: 2000,  nom_rate: 100   }
    ...
    output_ports:
        voltage:             { name: 'voltage',               protocol: 'push',  url: 'tcp://127.0.0.1:30003', blocking_mode: 'async', max_rate: 2000,  nom_rate: 100   }
