...
#include "motor_ctrl_super_msgpack.h"

using namespace gmt;

void MotorCtrlSuper::create_config() {
...
void MotorCtrlSuper::setup() {
    ...
    // create input ports
    new_input_port(heartbeat_in,              "heartbeat_in",          inputp_confs.heartbeat_in);
