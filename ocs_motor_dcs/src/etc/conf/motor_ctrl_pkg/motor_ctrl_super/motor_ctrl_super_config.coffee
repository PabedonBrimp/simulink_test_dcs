...
# Component  motor_ctrl_super instance configuration file
# Ports should be setup per instance

module.exports =

    properties:
        uri: { name: 'uri', default_value: 'gmt://motor_dcs/motor_ctrl_super/motor_ctrl_super' , type: 'String', desc: 'Uri path for the component' }
        name: { name: 'name', default_value: 'motor_ctrl_super' , type: 'String', desc: 'Name the component' }
        host: { name: 'host', default_value: '127.0.0.1' , type: 'String', desc: 'Default host for deployment.' }
        port: { name: 'port', default_value: 30000 , type: 'Integer', desc: 'Default configuration port' }
    ...
    input_ports:
        heartbeat_in:        { name: 'heartbeat_in',          protocol: 'pull',  url: 'tcp://127.0.0.1:30014', blocking_mode: 'async', max_rate: 100,   nom_rate: 100   }
